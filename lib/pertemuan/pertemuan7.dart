...
class _CompleteRadioButtonFormState extends State<RadiobuttonPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _jobOptions = [
    ...
    {'value': 'Programmer', 'icon': Icons.code, 'color': Color(0xFF4CAF50), 'description': 'Mengembangkan software'},
    {'value': 'Pengusaha', 'icon': Icons.business, 'color': Color(0xFFF44336), 'description': 'Mengelola bisnis'},
    {'value': 'Desainer', 'icon': Icons.design_services, 'color': Color(0xFF00BCD4), 'description': 'Kreativitas visual'},
  ];
